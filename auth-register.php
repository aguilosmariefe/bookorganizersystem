...
include_once("connection.php");
    ...
    if(isset($_POST['register'])){
      ...
      $sql="INSERT INTO `tbl_registration`(`first_name`, `last_name`, `email`, `password`,`password_confirm`) VALUES ('$fname','$lname','$email','$password','$password_confirm')";
...
<head>
  ...
  <title>Register - Organize Your Books</title>
  <!-- General CSS Files -->
