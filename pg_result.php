      ...
      <section class="section">
          <div class="section-body">
            <!-- add content here -->
                ...
                <?php 
                $search = $_GET['search'];
                $sql = "SELECT * FROM tbl_books WHERE book_title LIKE '%$search%' || book_author LIKE '%$search%' || genre LIKE '%$search%'|| publication_date LIKE '%$search%' || category_filter LIKE '%$search%' || description LIKE '%$search%' ORDER BY id DESC";
