<?php
    ...
    if(isset($_POST['update'])){
      ...
      $sql = "UPDATE tbl_books SET book_title='$title',book_author='$author',genre='$genre',publication_date='$published',category_filter='$filter',description='$desc' WHERE id='$id'";
...
<head>
  ...
  <title>Edit Book Info - Organize Your Book</title>
  <!-- General CSS Files -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                 ...
                 <li><a class="nav-link" href="recommendation.php">My Book Reviews</a></li>
                <li><a class="nav-link" href="new.php">New Release</a></li>
              </ul>
            </li>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="publication_date" value="<?php echo $row['publication_date'];?>">
                    </div>

                    <div class="form-group">
                      <label for="name">Filter</label>
                      <select class="form-control" name="category_filter" id="category_filter">
                        <option value="Want to Read" <?php echo ($row['category_filter'] == "Want to Read")? 'selected' : '';?>>Want to Read</option>
                        <option value="Finished" <?php echo ($row['category_filter'] == "Finished")? 'selected' : '';?>>Finished</option>
                        <option value="Favorite" <?php echo ($row['category_filter'] == "Favorite")? 'selected' : '';?>>Favorite</option>
                      </select>
                    </div>

                    <div class="form-group">
                      <label for="name">Description</label>
                      <input class="form-control" type="text" name="description" value="<?php echo $row['description'];?>"></input>
                    </div>
                  
              
                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="update">Update</button>
                  </div>
                </div>
